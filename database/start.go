...
func InitDatabase() {
	...
	err = DatabaseEngine.Sync2(new(UserModel), new(SettingModel), new(ApplyModel), new(SubjectModel), new(ChangeModel), new(MessageModel), new(ReportModel), new(LikeModel))
	if err != nil {
